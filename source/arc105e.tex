...
\begin{document}
	...
	\newpage
	\pagestyle{fancy}
	\lhead{\footnotesize \songti{Fourtune Cookies}}
	\cfoot{\footnotesize 第 \thepage \ 页\qquad  共  \pageref{LastPage} 页}
	
	\phantomsection
	\addcontentsline{toc}{section}{【ARC105A】Fourtune Cookies}
	\section*{【ARC105A】Fourtune Cookies}
	\rhead{\footnotesize \songti{ARC105A}}
	
	\phantomsection
	\addcontentsline{toc}{subsection}{题目描述}
	\subsection*{【题目描述】}
	
	给定四个正整数，判断能否将其分为总和相等的两组。
	
	\phantomsection
	\addcontentsline{toc}{subsection}{题解}
	\subsection*{【题解】}
	
	枚举第一组所包含的数即可，时间复杂度 $\mathcal{O}(1)$。
